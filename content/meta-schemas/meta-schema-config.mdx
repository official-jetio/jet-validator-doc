...
@jetio/validator provides short aliases for meta-schema URIs to cut verbosity. They work everywhere a meta-schema is accepted — the constructor, `validateSchema`, `compile`, and `compileAsync`.
