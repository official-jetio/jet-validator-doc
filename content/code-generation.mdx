...
The functions generated by @jetio/validator are not pretty 😅, meaning they aren't formatted, so you can use a formatter in your respective code editor to format the generated code. i.e prettier in VsCode
