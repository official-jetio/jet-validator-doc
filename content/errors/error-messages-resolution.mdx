...
> **v2 note:** In v2 the resolution model is fully unified. There are no boundary keywords with special behavior anymore — `anyOf`, `then`, `else`, `properties`, etc. all resolve the same way. The old "alt path" concept no longer exists.
