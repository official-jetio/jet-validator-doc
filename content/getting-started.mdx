...
For complete documentation see For complete documentation on `$data` references, see the [$data References](/advanced/data-keyword) section.
...
For complete documentation on `metaschemas` references, see the [metaschema](/meta-schemas/meta-schema-basics) section.
