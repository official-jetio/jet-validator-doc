...
description: "Install jet-validator, choose your schema language, and configure validation behavior."
---
...
With **jet-validator**, you do not need to choose an explicit schema language. jet-validator supports JSON Schema Draft 06 through 2020-12 seamlessly.
...
The compiler handles schemas from any accepted version flawlessly, removing the need for separate imports or separate jet-validator instances. The only extra configuration needed is for meta schemas (see [Meta Schema](/meta-schemas) section).
